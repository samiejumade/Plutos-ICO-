...
contract PlutosICO is Plutos{
    ...
    uint public preSaleEnd = block.timestamp + 1642485076; //ONE WEEK OF PRESALE
    ...
    uint public seedSaleStart = block.timestamp + 3284970152; // AFTER ONE WEEK OF PRESALE
    uint public seedSaleEnd = block.timestamp + 6569940304; // TWO WEEKS FOR SEEDSALE
